...
def compute(rule=None, resetting_to=NO_VALUE, name=None):
    return _build_descriptor(
        rule=rule, resetting_to=resetting_to, factory=LazyCell, optional=True,
        __name=name
    )

def maintain(rule=None, make=None, initially=NO_VALUE, resetting_to=NO_VALUE, optional=False, name=None):
    return _build_descriptor(
...
def perform(rule=None, optional=False, name=None):
    return _build_descriptor(
...
def todo(rule=None, name=None):
    """Define an attribute that can send "messages to the future" """
    return _build_descriptor(rule=rule, __proptype = TodoProperty.mkattr, __name=name)
...
def make(rule=None, writable=False, optional=True, name=None):
...
def cellcache(rule=None, make=None, initially=NO_VALUE, resetting_to=NO_VALUE, name=None):
    return _build_descriptor(
        rule=rule, initially=initially, resetting_to=resetting_to, make=make,
...
class Dict(UserDict.IterableUserDict, Component):
    ...
    of the dictionary.
    """
    added = todo(dict, name='added')
    deleted = todo(dict, name='deleted')
    changed = todo(dict, name='changed')
    ...
    def data(self):
        ...
        return data
    data = maintain(data, make=dict, name='data')
...
class List(UserList.UserList, Component):
    ...
    updated = todo(lambda self: self.data[:], name='updated')
    future  = updated.future
    changed = todo(bool, name='changed')
    ...
    def data(self):
        if self.changed:
            ...
            return self.updated
        return self.data
    data = maintain(data, make=list, name='data')
...
class Set(sets.Set, Component):
    ...
    """
    _added = todo(set, name='_added')
    _removed = todo(set, name='_removed')
    ...
    def _data(self):
        ...
        return data
    _data = maintain(_data, make=dict, name='_data')
